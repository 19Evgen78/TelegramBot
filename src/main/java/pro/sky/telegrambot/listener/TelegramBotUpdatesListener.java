...
//Класс, отвечающий за получение {@link Update} от {@link TelegramBot}
    // и их обработку и дальнейшее распределение.
@Service
public class TelegramBotUpdatesListener implements UpdatesListener {
    ...
    private void processingMessage(String textMessage, Long userId) {
     ...
     // Метод для проверки записей в базе данных на необходимость отправки напоминания пользователю.
     // Проверка происходит раз в минуту.
